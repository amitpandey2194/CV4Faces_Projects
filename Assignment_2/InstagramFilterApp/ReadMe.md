...
After running the above command you can locate your .exe file with the name InstagramFilterApp in the Release Folder

5. run the command in CMD (Windows): InstagramFilterApp.exe "Path to the First Image"
